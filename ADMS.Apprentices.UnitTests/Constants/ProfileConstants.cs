...
namespace ADMS.Apprentices.UnitTests.Constants
{
    public static class ProfileConstants
    {
        ...
        public static PriorQualification Qualification => new() {QualificationCode = "QCode", QualificationDescription = "QDescription", QualificationLevel = "1101", QualificationANZSCOCode = "1101", QualificationManualReasonCode = PriorQualification.ManuallyEnteredCode, StartDate = new DateTime(2000, 10, 1), EndDate = new DateTime(2002, 10, 1)};
        public static PriorApprenticeshipQualification PriorApprenticeshipQualification => new() {EmployerName = "employer-name", QualificationCode = "QCode", QualificationDescription = "QDescription", QualificationLevel = "1101", QualificationANZSCOCode = "1101", QualificationManualReasonCode = PriorApprenticeshipQualification.ManuallyEnteredCode, StartDate = new DateTime(2000, 10, 1), ApprenticeshipReference = "apprenticeship-reference"};
