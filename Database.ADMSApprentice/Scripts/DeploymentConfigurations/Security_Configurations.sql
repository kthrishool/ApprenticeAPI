...
UNION	SELECT		'DEV,TEST'			,N'NATION\MGT_DEV_ADMS_DW'				,N'db_datareader'
UNION	SELECT		'DEV,TEST'			,N'NATION\MGT_DEV_ADMS_DW'				,N'CDCRole'
UNION	SELECT		'DEV'				,N'NATION\MGT_DEV_ADMS_Developer'		,N'db_datawriter'
UNION	SELECT		'DEV'				,N'NATION\MGT_DEV_ADMS_DW'				,N'db_datawriter'
...
UNION	SELECT		'DEV,TEST'			,N'ENETDEV\Service_ADMSAPIDTE_d'		,N'_LegacyRole'
...
UNION	SELECT		'PREPROD'			,N'ENETPPROD\Service_ADMSAPIDTE_p'		,N'_LegacyRole'
...
UNION	SELECT		'PROD'				,N'ENETAPP\Service_ADMSAPIDTE'			,N'_LegacyRole'
